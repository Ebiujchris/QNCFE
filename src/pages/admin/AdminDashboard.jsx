...
function AdminDashboard({ user }) {
  ...
  const assignProvider = async () => {
    ...
    try {
      ...
      showSuccess(`Provider assigned successfully! Patient and provider have been notified.`)
      ...
      <div className="dashboard-header">
        <div style={{textAlign: 'center'}}>
          ...
          <p style={{color: '#6b7280', fontSize: '1.125rem'}}>
            Manage QNC Solutions system and oversee all operations
          </p>
        </div>
      </div>
          ...
          <div className="card card-elevated" style={{width: '600px', maxWidth: '100%', maxHeight: '90vh', overflowY: 'auto'}}>
            ...
            <div style={{display: 'flex', gap: '12px', marginTop: '24px'}}>
              <button 
                ...
                className="btn btn-success"
                disabled={!selectedProvider || assignmentLoading}
                style={{flex: 1}}
              >
